Para este punto se creó una clase MultiplesOrders que usa una FIFO para tratar con un conjunto de órdenes, las tuplas se usan para crear comobos especiales en el módulo menu.py
